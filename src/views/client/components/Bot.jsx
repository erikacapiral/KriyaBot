...
import Request_Agent from './Request_Agent';
...
const Bot = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5">
            ...
            <Request_Agent />
            <button
                className="w-16 h-16 rounded-full bg-[#D9D9D9] text-white flex items-center justify-center shadow-lg transition duration-300 z-50 relative"
