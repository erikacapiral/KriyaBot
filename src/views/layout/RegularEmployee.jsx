...
const RegularEmployee = () => {
    ...
    const initials = getInitials(user.f_name, user.s_name);
                ...
                <div className="w-72 min-h-full bg-white flex flex-col items-center relative">
                    ...
                    <div className="mt-10 w-full flex flex-col flex-nowrap gap-3">
                                ...
                                <div className="flex flex-row justify-start items-center gap-8 w-full">
                                    ...
                                    <div className="flex flex-row justify-between items-center w-full">
                                        <div className="flex flex-row flex-nowrap justify-start items-center gap-2">
                                            ...
                                            <span className="text-[#A9A9A9] text-[14px] select-none">
                                                Client Side - Request Agent
                                            </span>
                                        </div>
                                    </div>
                                </div></NavLink>) : (<NavLink to="/regular/my-personal-information">
                                    <div className="flex flex-row justify-start items-center gap-8 w-full">
                                        <div className="invisible bg-none h-7 w-[6px] rounded-r-[8px]" />
                        ...
                        <div className="box-border flex flex-col gap-3" ref={pulseSubNav}>
                            <NavLink to={"/regular/my-pulse/mood-tracker"}>
                                {(isActive) => {
                                    return isActive.isActive ? (
                        ...
                        <div className="flex flex-row justify-start items-center gap-8 w-full">
                            ...
                            <div className="flex flex-row justify-between items-center w-full">
                                <div className="flex flex-row flex-nowrap justify-start items-center gap-2">
                                    ...
                                    <span className="text-[#A9A9A9] text-[14px] select-none">Team Chart</span>
                                </div>
                        ...
                        <NavLink to="/regular/hr-request">
                            {(isActive) => {
                                return isActive.isActive ? (
                                    <div className="flex flex-row justify-start items-center gap-8">
                                        <div
                                            className="bg-[#EC7E30] h-7 w-[6px] rounded-r-[8px] select-none"
                                        />
